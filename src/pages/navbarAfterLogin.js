  ...
  return (
    <div class="bg-light-gray">
      ...
      <div class="container-fluid px-0">
        <header>
          {/* <!-- <img src={require("../assests/img/team.jpg" class="img-fluid header-img" alt=""> --> */}
          ...
          <div id="mySidenav" class="sidenav bg-warning">
            <div class="bg-white">
              ...
              {/* <!-- <div class="nav-header bg-warning text-white pl-4 pb-4">
                        ...
                        <h5><a href="#" class="text-white font-weight-bold" data-toggle="modal" data-target="#loginModal">LogIn</a></h5>
                    </div> --> */}
              <div class="nav-body bg-white">
                <a href="/page12.html">
                  <img src={require("../assests/img/homw.svg").default} alt="" />{" "}
                  Dashboard{" "}
                </a>
                <a href="/page9.html">
                  <img
                ...
                <a href="/page8.html" class="active-link">
                  <img
