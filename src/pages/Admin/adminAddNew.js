              ...
              <div class="container">
                <div class="row">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 bg-white">
                    ...
                    <hr />
                    <div class="row">
                      <div class="col-xl-10 col-lg-10 col-md-10 col-sm-6 col-6 my-2">
                        <h4>Participant Information</h4>
                        <p class="grey-font">Basic details</p>
                      </div>
                      <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6 my-2">
                        ...
                        <div class="row mt-4">
                          ...
                          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 mt-4">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12 mt-2 text-center">
                                <span class="">To</span>
                              </div>
                              <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12 ">
                                <input
