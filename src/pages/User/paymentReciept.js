      ...
      <div class="container bg-light-gray px-4 py-4">
        <div class="row">
          <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8">
            <img
              src={require("../../assests/xdExport/transparentBlackLogo.png").default}
              alt=""
            />
          </div>
          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 mt-4">
            ...
            <span class="float-right grey-font">Ahmedabad, Gujarat 380004</span>
          </div>
        </div>
        ...
        <div class="row mt-4">
          ...
          <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 mt-4">
            <div class="float-right mt-4">
              ...
              <span class="grey-font float-right">January 1, 2018</span> <br />
      ...
      <div class="container bg-white mt-4">
        <div class="row mt-4 px-4">
          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 mt-4">
            <p class="text-light-blue font-weight-600">Name of Participants</p>
          </div>
          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 mt-4">
          ...
          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 mt-4">
            <p class="text-light-blue float-right font-weight-600">Amount</p>
          </div>
        </div>
        <div class="row mt-4 pt-4">
          ...
          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 mt-4">
            <p class="ml-4 text-center">Ahmedabad 3AC Train</p>
          </div>
          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 mt-4">
            <p class=" float-right">INR 14,000</p>
          </div>
        </div>
        <hr class="my-2" />
        <div class="row">
          ...
          <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 mt-4">
            <p class=" float-right">INR 12,000</p>
          </div>
        </div>
        <hr class="my-2" />
        <div class="row mb-4 ">
          <div class="col-xl-6 col-lg6 col-md-6 col-sm-6 col-6 mt-4">
          ...
          <div class="col-xl-6 col-lg6 col-md-6 col-sm-6 col-6 mt-4">
            <div class="row">
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 ">
                <p class="float-right">INR 26,000</p>
              </div>
            </div>
            <hr />
            <div class="row">
              ...
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 ">
                <p class="float-right">INR 1300</p>
              </div>
            </div>
            <hr />
            <div class="row">
        ...
        <div class="mt-45 ">
          ...
          <p class="grey-font">
            ...
            before joining camp. In case of any queries, kindly reach out to us
            at <span class="font-weight-bold"> +91 9924246267 </span>
          </p>
